...
/**
 * This is the item provider adapter for a {@link sense.Capability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Capability_time_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Capability_time_feature", "_UI_Capability_type"),
         SensePackage.Literals.CAPABILITY__TIME,
         true,
         false,
         false,
  ...
  protected void addProcessorPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Capability_processor_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Capability_processor_feature", "_UI_Capability_type"),
         SensePackage.Literals.CAPABILITY__PROCESSOR,
         true,
         false,
         true,
         null,
  ...
  protected void addPerformsPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Capability_performs_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Capability_performs_feature", "_UI_Capability_type"),
         SensePackage.Literals.CAPABILITY__PERFORMS,
         true,
         false,
         true,
         null,
  ...
  {
    BigDecimal labelValue = ((Capability)object).getTime();
