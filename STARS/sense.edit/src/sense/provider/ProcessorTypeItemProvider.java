...
/**
 * This is the item provider adapter for a {@link sense.ProcessorType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         SensePackage.Literals.PROCESSOR_TYPE__NAME,
         true,
         false,
         false,
  ...
  protected void addCountPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ProcessorType_count_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ProcessorType_count_feature", "_UI_ProcessorType_type"),
         SensePackage.Literals.PROCESSOR_TYPE__COUNT,
         true,
         false,
         false,
  ...
  protected void addCapabilitiesPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ProcessorType_capabilities_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ProcessorType_capabilities_feature", "_UI_ProcessorType_type"),
         SensePackage.Literals.PROCESSOR_TYPE__CAPABILITIES,
         true,
         false,
         true,
         null,
