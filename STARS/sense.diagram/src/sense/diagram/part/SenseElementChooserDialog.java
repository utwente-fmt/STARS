 ...
 * @generated
 */
public class SenseElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public SenseElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.SenseElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "sense".equals(fileExtension); //$NON-NLS-1$
	}
