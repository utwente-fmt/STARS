...
import sense.diagram.part.SenseDiagramEditorUtil;

/**
 * @generated
 */
public class SenseMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = SenseDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			SenseDiagramEditorUtil.selectElementsInDiagram(editor,
