...
import sense.diagram.edit.policies.SenseTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ChannelNameInitialTokensSourceEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				SenseVisualIDRegistry
						.getType(sense.diagram.edit.parts.ChannelNameInitialTokensSourceEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ChannelNameInitialTokensSourceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SenseTextSelectionEditPolicy());
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					SenseEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new ChannelLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ChannelLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ChannelLabelFigure() {
