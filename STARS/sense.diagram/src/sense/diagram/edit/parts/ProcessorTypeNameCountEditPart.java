 ...
 * @generated
 */
public class ProcessorTypeNameCountEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ProcessorTypeNameCountEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return SenseElementTypes.getImage(parserElement.eClass());
	}
			...
			parser = SenseParserProvider
					.getParser(
							...
							SenseVisualIDRegistry
									.getType(sense.diagram.edit.parts.ProcessorTypeNameCountEditPart.VISUAL_ID));
		}
		return parser;
	}
