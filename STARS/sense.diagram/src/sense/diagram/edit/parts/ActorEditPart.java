...
import sense.diagram.edit.policies.ActorItemSemanticEditPolicy;
...
public class ActorEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(SenseElementTypes.Channel_4001);
		return types;
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof sense.diagram.edit.parts.ActorEditPart) {
			types.add(SenseElementTypes.Channel_4001);
		}
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == SenseElementTypes.Channel_4001) {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == SenseElementTypes.Channel_4001) {
			types.add(SenseElementTypes.Actor_2001);
		} else if (relationshipType == SenseElementTypes.Capability_4003) {
			types.add(SenseElementTypes.ProcessorType_2002);
		}
		return types;
	}
