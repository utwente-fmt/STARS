 ...
 * @generated
 */
public class CapabilityTimeEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				SenseVisualIDRegistry
						.getType(sense.diagram.edit.parts.CapabilityTimeEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public CapabilityTimeEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new CapabilityLabelFigure();
	}

	/**
	 * @generated
	 */
	public class CapabilityLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public CapabilityLabelFigure() {
			this.setText("Capability");
		}
